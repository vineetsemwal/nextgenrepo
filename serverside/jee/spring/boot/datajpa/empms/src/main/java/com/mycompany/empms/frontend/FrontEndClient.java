...
public class FrontEndClient {
    ...
    public void render() {
        try {
            Employee emp1 = service.add("sadique", 25);
            display(emp1);
            ...
            List<Employee>foundByName=service.fetchByName("sadique");
            displayEmployees(foundByName);

            System.out.println("****find employees greater than age 26");
            List<Employee>foundByAge=service.fetchByAgeGreaterThan(26);
            displayEmployees(foundByAge);
